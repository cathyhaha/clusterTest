...
def plot(data, density_threshold, distance_threshold, auto_select_dc = False):
	...
	rho, delta, nneigh = dpcluster.cluster(load_paperdata, data, density_threshold, distance_threshold, auto_select_dc = False)
...
if __name__ == '__main__':
	...
	plot('./data/data_others/weightPCA2dat.dat',16.14,1.3,False)
