...
if __name__ == "__main__":  
    ...
    corpus = '../data/corpus5-10'  
    stopWords = open('../data/stopwords/chineseStopWords-utf8.txt', 'r').read()   
    resultPath = '../data/results/resultsAfterStopWords.txt'  
    
    k = 5     
    
    #得到语料库文件路径
    allDirPath = PreprocessDoc(corpus) 
    #处理语料库（分词，去除停用词） 
    SaveDoc(allDirPath, resultPath, stopWords)   
    #转化为VSM
    weight = TFIDF(resultPath) 
    #PCA降维  
